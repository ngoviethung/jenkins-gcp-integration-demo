    ...
    <div class="{{ $crud->getListContentClass() }}">
      <div class="">
        ...
        <div class="row mb-0">
          ...
          <div class="row">
                  @if ( $crud->buttons()->where('stack', 'top1')->count() ||  $crud->exportButtons())
                      <div class="hidden-print {{ $crud->hasAccess('create')?'with-border':'' }}" style="display: contents;">
                          @include('crud::inc.button_stack', ['stack' => 'top1'])
                      </div>
                  @endif
          </div>
